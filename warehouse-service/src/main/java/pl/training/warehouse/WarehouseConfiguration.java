...
import pl.training.warehouse.adapters.output.persistence.JpaProductRepository;
import pl.training.warehouse.adapters.output.persistence.JpaProductRepositoryAdapter;
import pl.training.warehouse.adapters.output.persistence.JpaProductRepositoryMapper;
import pl.training.warehouse.adapters.output.persistence.ProductEntity;
